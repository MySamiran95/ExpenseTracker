...
async function getChartData() {
    ...
    const listData = lineChartData.getData48;                   //Change the data here
...
let listData = finalData.getData48;   //Change the Data Here
...
averageAmount.innerHTML = formatIndianNumber(averageData[23][1])
